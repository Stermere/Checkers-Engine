...
def main(args) -> None:
    ...
    player = 1
    board = Board()
    gui = Gui(board.board, size, clock, screen, 2) # must be initialized regardless of if a human is playing or not
    ...
    while True:
        ...
        # player 2's turn
            ...
            # the bot
            player2 = start_processing(board.board, 1, P_TIME, gui, PLY)
