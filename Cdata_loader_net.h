// provides the functions to load save and create data sets from the python list input of games, the predicted value at that location
// and the end game state of the game. allowing for the creation of a data set for training and testing.
// and to create the data set for the neural network
...
// function to calculate the actual values of the data set
